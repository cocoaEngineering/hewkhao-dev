...
export default function Home() {
  return (
<div class="container mx-auto w-[40rem]  h-[40rem] translate-y-[12rem] ">
    ...
    <div class=" w-full  h-[2rem] flex items-center justify-end pr-2 font-medium ">
      <a class="pr-3 font-bold cursor-pointer">Login</a>
      <a class="cursor-pointer" href="/Sign_Up">Sign Up</a>
    </div>
...
<div>
 ...
 <div class=" translate-y-[0.9rem] w-full  h-[2rem] flex items-center justify-stert font-medium">
      <a class="pr-3 font-bold cursor-pointer">Forgot Password?</a>
    </div>
     
    <button class="translate-y-[1.5rem] block w-full rounded-md border-0 py-1.5 pl-20 pr-20 ring-1 ring-inset text-gray-900  ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 font-bold ">Login</button>
